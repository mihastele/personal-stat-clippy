import { Music, Gamepad2, Github, Trophy, Clock, TrendingUp, Activity } from 'lucide-react'
              ...
              return (
                <div key={index} className="bg-dark-800/50 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className={`p-1.5 rounded-lg ${platformColors[item.platform.toLowerCase()]}`}>
            ...
            {dashboardOverview.activityFeed.map((activity, index) => {
              ...
              return (
                <div key={index} className="flex gap-3">
                  <div className={`p-2 rounded-lg h-fit ${platformColors[activity.platform]}`}>
                    <Icon className="w-4 h-4" />
                  </div>
